...
*/
class College4 {
  List<String> Important_links =["University website"
  ," Student services"
  ," University calendar"
  ,"University map"
  ,"Registration site"
  ...
  ,"College group"];
      ...
      void Definition_of_college(){
        print("""     The College of Nursing is an academic
         ...
         and a bachelor’s degree in midwifery after successfully completing (136) credit hours of study distributed over four years of study.
